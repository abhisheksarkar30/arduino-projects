...
else if(digitalRead(3)&&!digitalRead(4)&&!digitalRead(5)&&!digitalRead(6))//90 left
{
  /*digitalWrite(rf,HIGH);
  digitalWrite(rb,LOW);
...
else if(!digitalRead(3)&&!digitalRead(4)&&!digitalRead(5)&&digitalRead(6))//90 right
{
  /*digitalWrite(rf,LOW);
...
else if(digitalRead(3)&&digitalRead(4)&&(!digitalRead(5)||!digitalRead(6)))//45 left
{
  digitalWrite(rf,HIGH);
  digitalWrite(rb,LOW);
  digitalWrite(lb,LOW);
...
else if((!digitalRead(3)||!digitalRead(4))&&digitalRead(5)&&digitalRead(6))//45 right
{
  digitalWrite(rf,LOW);
  digitalWrite(rb,LOW);
  digitalWrite(lb,LOW);
