...
void loop() {
 ...
 delay(50);                     // Wait 50ms between pings (about 20 pings/sec). 29ms should be the shortest delay between pings.
  Serial.print("Ping: ");
  int front=sonar1.ping_cm(),right=sonar2.ping_cm(),back=sonar3.ping_cm(),left=sonar4.ping_cm(),below=sonar5.ping_cm();//sensor placement. flag 1,2,3,4,5 respectively. 0 - all direction block
